...
export default class AlloyFinger extends Component<any, any> {
  preV: any
  pinchStartLen: any;
  scale: number;
  isSingleTap: boolean;
  ...
  _emitEvent(name: string, ...arg: any[]) {
    if (this.props[name]) {
      this.props[name](...arg);
    }
  }

  _handleTouchStart (evt: any) {
  ...
  _swipeDirection (x1: any, x2: any, y1: any, y2: any) {
